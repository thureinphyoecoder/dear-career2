...
DEFAULT_FROM_EMAIL = os.getenv("DJANGO_DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "no-reply@dear.thureinphyo.com")
JOB_ALERT_FROM_EMAIL = os.getenv("DJANGO_JOB_ALERT_FROM_EMAIL", DEFAULT_FROM_EMAIL)
