...
export function PublicFooter() {
  ...
  return (
    <footer className="mt-auto px-3 pb-4 pt-10 sm:px-4 sm:pb-5 sm:pt-12">
      <div className="w-full">
        <div className="grid w-full gap-4 rounded-[1.7rem] border border-[rgba(160,183,164,0.18)] bg-[rgba(255,255,255,0.76)] p-3 shadow-soft backdrop-blur-xl sm:rounded-[2.2rem] sm:p-5">
          <div className="grid grid-cols-1 items-start gap-2 md:grid-cols-2 lg:gap-3 2xl:grid-cols-4">
            <section className="grid content-start gap-4 self-start p-3 sm:p-5">
              <BrandLogo compact />
              <div className="grid gap-4">
                <div className="text-xs uppercase tracking-[0.16em] text-[#8da693]">
                  Curated Thailand Jobs
                </div>
                <p className="mb-0 max-w-[34rem] text-[0.94rem] leading-6 text-[#727975] sm:text-[0.98rem] sm:leading-7">
            ...
            <section className="grid content-start gap-5 self-start p-3 sm:p-5">
          ...
          <div className="flex justify-center border-t border-[rgba(160,183,164,0.14)] px-2 pt-4 text-center text-xs text-[#727975] sm:text-sm">
