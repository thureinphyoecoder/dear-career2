  ...
  return (
    <footer className="mt-auto px-3 pb-4 pt-10 sm:px-4 sm:pb-5 sm:pt-12">
      <div className="w-full">
        <div className="grid w-full gap-4 rounded-[1.7rem] border border-[rgba(160,183,164,0.18)] bg-[rgba(255,255,255,0.76)] p-3 shadow-soft backdrop-blur-xl sm:rounded-[2.2rem] sm:p-4 lg:p-5">
