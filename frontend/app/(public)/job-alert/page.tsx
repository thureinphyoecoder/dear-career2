...
export default function JobAlertPage() {
  return (
    <main className="mx-auto grid max-w-3xl gap-5 px-4 pb-20 pt-32">
      <section className="grid gap-3 rounded-[1.5rem] border border-[rgba(160,183,164,0.2)] bg-white p-6">
      ...
      <section className="rounded-[1.5rem] border border-[rgba(160,183,164,0.2)] bg-white p-6">
