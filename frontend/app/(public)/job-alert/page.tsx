...
export default function JobAlertPage() {
  return (
    <main className="mx-auto grid w-full max-w-6xl gap-6 px-4 pb-20 pt-32">
      <section className="grid gap-5 rounded-[1.5rem] border border-[rgba(160,183,164,0.2)] bg-white p-6 md:p-8 lg:p-10">
